...
.addEventListener("click", function(){
  ...
  document.querySelector("#cntr-nav .ri-close-fill").style.display = "initial"
  document.querySelector("#cntr-nav .ri-menu-line").style.display = "none"
  // document.querySelector("#chainn").style.cursor = "pointer"
})

document.querySelector("#cntr-nav .ri-close-fill")
.addEventListener("click", function(){
  document.querySelector(".upar-menu").style.top = "-100%"
  document.querySelector("#cntr-nav .ri-close-fill").style.display = "none"
